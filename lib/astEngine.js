...
// Parses a single source file into its structural n-gram fingerprint.
// Returns whether tree-sitter hit any ERROR nodes so callers can flag that
// a score might be unreliable (e.g. the file had a syntax error).
